...
trims that white point a fraction of a percent per frame toward whatever makes
the scene's grey pixels render grey, so daylight colour tracks the weather

...
Examples:
  ...
  python3 -m raspilapse.cli.apply_overlay test_photos/kringelen_2025_11_05_10_30_45.jpg

  # Apply overlay to multiple images
  python3 -m raspilapse.cli.apply_overlay test_photos/*.jpg

  # Specify custom metadata and output
  python3 -m raspilapse.cli.apply_overlay image.jpg -m metadata.json -o output.jpg

  # Override mode for overlay
  python3 -m raspilapse.cli.apply_overlay image.jpg --mode night

  # Batch process with different output directory
  python3 -m raspilapse.cli.apply_overlay test_photos/*.jpg --output-dir overlayed/
        """,
    )
